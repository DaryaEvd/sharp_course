...
public class HRManager
{
    ...
    public HRManager(List<Junior> juniors, List<TeamLead> teamLeads, IMatchingStrategy matchingStrategy)
    {
        _juniors = juniors;
    ...
    {
        return _matchingStrategy.ExecuteMatchingAlgorithm(_juniors, _teamLeads);
    }
